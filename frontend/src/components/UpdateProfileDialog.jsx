            ...
            <Dialog open={open}>
                <DialogContent className="sm:max-w-[425px]" onInteractOutside={() => setOpen(false)}>
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        {
                            loading ? <Button className="w-full my-4"><Loader2 className='m-2 h-4 w-4 animate-spin' /> Please wait</Button> : <Button type="submit" className="w-full my-4">Update</Button>
                        }
                    </form>
                    <DialogFooter>
                    </DialogFooter>
